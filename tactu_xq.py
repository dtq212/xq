...
class TacTu:
    ...
    def action_xulyuutiensudungkynang(self, loaikynang, vitrikynang, diachimuctieu, khoangcachyeucau = 0, is_ngatdichuyen = False):
        loaicannmuctieu = ("sudungkynangmuctieu", "tancongvatly", "sudungkynangphudau", "sudungkynanglendongdoi", "dichuyentiepcancanchien", "dichuyentiepcantamxa", "dichuyengiukhoangcach")
        if not diachimuctieu and loaikynang in loaicannmuctieu:
            return False
    ...
    def _action_tancong_thucsondao(self):
        ...
        danhsachuutien = [
            ...
            (VITRIKYNANG_LUCPHACHHOASON, "sudungkynangmuctieu", lambda: noiluc > 50 and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN, KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False),
            ...
            (VITRIKYNANG_DONDAOTRUCNHAP, "sudungkynangmuctieu", lambda: noiluc > 50, KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False),
    ...
    def action_muauto(self):
        self.moitruong.action_thucthicaulenh("auto buy 3 1")
