...
class TacTu:
    ...
    def action_tudongsudungvatpham(self):
        if self._is_tudongsudungvatpham:
            ...
            if not self._is_dasudungbaothuvatpham:
                ...
                if thoigiantulangoicu > 0.5 and time.time() - self._thoidiemyeucaubaothuvatphamdoilenhgannhat > 1.0:
            ...
            if time.time() - self._thoidiemkiemtrahieuunggannhat > 2.5:
                ...
                if is_bandopk and phantramsinhlucconlai < 50. and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_HUYETTHACH,), True, is_hieuungcoloi = 1):
            ...
            if not self._is_tudongdichientruong:
                ...
                if is_dangbatpk and is_bandopk and self._is_tudongsudungkynang and phantramsinhlucconlai <= 50 and time.time() - self._thoidiemsudungvatphamhoisinhlucgannhat > 5.:
                    if self.moitruong.action_timkiemvatphamhanhtrang(CAPCUUDON):
                        self._thoidiemsudungvatphamhoisinhlucgannhat = time.time()
                        self.action_sudungvatphamhanhtrang(CAPCUUDON, delay = 0.)

                if is_dangbatpk and is_bandopk and self._is_tudongsudungkynang and phantramnoilucconlai <= 50 and time.time() - self._thoidiemsudungvatphamhoinoilucgannhat > 5.:
    ...
    def action_sudungkynangmonphaidaohoanguyen(self):
        ...
        danhsachuutien = [
            ...
            (VITRIKYNANG_PHONGMAQUYET, "sudungkynangmuctieu", lambda: diachimuctieu and is_muctieulanguoichoi and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VITRIKYNANG_PHONGMAQUYET] and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN and self.moitruong.get_idloaivukhi(diachimuctieu) != LOAIVUKHI_AMKHI and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_TRAMMAC, HIEUUNGKYNANG_CHOANG), macdinh = True, is_hieuungcoloi = 0, diachicosothongtinnhanvat = diachimuctieu), KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False, True),
            ...
            # (VITRIKYNANG_PHANTOA, "sudungkynangmuctieu", lambda: diachimuctieu and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VITRIKYNANG_PHANTOA], KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False, True),
    ...
    def action_sudungkynangmonphaimaoson(self):
        ...
        danhsachuutien = [
            ...
            (VITRIKYNANG_DITINHDAIPHAP, "sudungkynangkhongmuctieu", lambda: noilucconlai > 150 and time.time() - self._thoidiemsudungditinhdaiphapgannhat > 119 and self._is_tudongvebanrac, 0, None, True, False),
            (VITRIKYNANG_LUUHUYETTHUAT, "sudungkynangkhongmuctieu", lambda: noilucconlai > 150 and time.time() - self._thoidiemsudungluuhuyetthuatgannhat > 121 and self._is_tudongvebanrac, 0, None, True, False),
    ...
    def action_sudungkynangmonphaivanmongcoc(self):
        ...
        danhsachuutien = [
            ...
            (VITRIKYNANG_PHONGANTHUAT, "sudungkynangmuctieu", lambda: noilucconlai > 200 and diachimuctieu and is_muctieulanguoichoi and khoangcachmuctieutancong <= KHOANGCACHSUDUNGKYNANGTAMXA and self.moitruong.get_idloaivukhi(diachimuctieu) != LOAIVUKHI_AMKHI and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_TRAMMAC, HIEUUNGKYNANG_CHOANG), False, diachicosothongtinnhanvat = diachimuctieu, is_hieuungcoloi = 0), KHOANGCACHSUDUNGKYNANGTAMXA, None, True),
        ...
        if self._is_tudongdieukhienbaothu:
            while True:
                ...
                for sothutu in range(1, SOLUONGBAOTHUTOIDA + 1):
                    ...
                    is_baothudangogan = idbandohientaidoituongbaothu == idbandohientai and khoangcach <= KHOANGCACHSUDUNGKYNANGTAMXA
                    ...
                    if is_baothukynangtrieuhoi:
                        ...
                        if self._is_danggomquai or not is_baothudangogan:
                            ...
                            if self.moitruong.get_is_cothetancong(diachimuctieu) and self.moitruong.get_khoangcachdiem(*toadodoituongbaothu, diachimuctieu) <= KHOANGCACHSUDUNGKYNANGTAMXA:
                        ...
                        if self.moitruong.get_idbandohientai() in BANDOKHONGPKs and self.moitruong.get_trangthaihanhvidoituongbaothu(sothutu) != 3:
                            self.moitruong.action_ralenhbaothudungim(iddoituongbaothu)
    ...
    def action_tudongkhaikhoang(self):
        ...
        if 0:
            ...
            while True:
                ...
                tenvatphamkhangs = ("Hoàng Kỳ", "Cúc Dại", "Quả Anh Túc", "Điền Thất", "Táo Đỏ", "Trần Bì", "Dương Kim Hoa", "Linh Chi Thảo", "Sơn Sâm", "Cát Cánh", "Cam Thảo", "Sinh Địa", "Xuyên Tâm Liên", "Hoàng Liên")
