...
class TacTu:
    ...
    def action_xulyuutiendichuyen(self):
        ...
        tendoituongmuctieudangchon = diachimuctieudangchon and self.moitruong.get_tendoituong(diachimuctieudangchon)
        ...
        is_muctieudangchonlabaothugiangho = diachimuctieudangchon and self.moitruong.get_is_baothugiangho(tendoituongmuctieudangchon)
    ...
    def action_tudongtimkiemmuctieu(self):
        ...
        if diachicosothongtinnhanvatmuctieudangchon:
            ...
            is_muctieudangchonlacuongthi = any(tenbaothu in tendoituongmuctieudangchon for tenbaothu in BAOTHUKYNANGTRIEUHOIs)
        ...
        while True:
            ...
            is_muctieuxemxetlacuongthi = tendoituongmuctieuxemxet and any(tenbaothu in tendoituongmuctieuxemxet for tenbaothu in BAOTHUKYNANGTRIEUHOIs)
    ...
    def _action_tancong_duongmon(self):
        ...
        tendoituongmuctieu = diachimuctieu and self.moitruong.get_tendoituong(diachimuctieu)
        is_muctieulacuongthi = tendoituongmuctieu and any(tenbaothu in tendoituongmuctieu for tenbaothu in BAOTHUKYNANGTRIEUHOIs)
        is_muctieulabaothugiangho = diachimuctieu and self.moitruong.get_is_baothugiangho(tendoituongmuctieu)
    ...
    def _action_tancong_daohoanguyen(self):
        ...
        danhsachuutien = [
            ...
            # (VIRIKYNANG_NGUYENKHIQUYNGUYEN, "sudungkynangkhongmuctieu", lambda: phantramsinhlucconlai >= 50 and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VIRIKYNANG_NGUYENKHIQUYNGUYEN] and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_NGUYENKHIQUYNGUYEN,), True, is_hieuungcoloi = 1), 0, None, False, False),
            # (VIRIKYNANG_NGUYENKHIQUYNGUYEN, "sudungkynangkhongmuctieu", lambda: phantramsinhlucconlai <= 25 and self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_NGUYENKHIQUYNGUYEN,), True, is_hieuungcoloi = 1), 0, None, False, False),
            ...
            (VITRIKYNANG_DAIHAIVOLUONG, "sudungkynangkhongmuctieu", lambda: diachimuctieu and self._is_nhieumuctieugan3 and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VITRIKYNANG_DAIHAIVOLUONG] and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN, KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False, False),
            (VITRIKYNANG_DAOHOALACANH, "sudungkynangkhongmuctieu", lambda: khoangcach < KHOANGCACHSUDUNGKYNANGCANCHIEN and diachimuctieu and is_muctieupk and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VITRIKYNANG_DAOHOALACANH] and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN, KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False, True),
            ...
            (VITRIKYNANG_NHATQUYENBATSON, "sudungkynangmuctieu", lambda: diachimuctieu and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VITRIKYNANG_NHATQUYENBATSON] and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN and (is_muctieupk or not self._is_nhieumuctieugan3), KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False, True),
            ...
            (VITRIKYNANG_HACHODAOTAM, "sudungkynangmuctieu", lambda: diachimuctieu and nguyenkhiconlai >= NGUYENKHIYEUCAUKYNANGDAOHOANGUYEN_MAP[VITRIKYNANG_HACHODAOTAM] and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN, KHOANGCACHSUDUNGKYNANGCANCHIEN, None, False, True),
    ...
    def _action_tancong_maoson(self):
        ...
        # Cấu trúc: (vitrikynang, loaikynang, dieukien, khoangcachyeucau, target, is_yeucaukhongdichuyen)
        danhsachuutien = [
    ...
    def _action_tancong_vanmongcoc(self):
        ...
        for item in danhsachungviens:
            ...
            if is_khongbithieudot and (phantramsinhlucconlai < 33 or (not is_datinhcuongluc and phantramsinhlucconlai <= 66)):
                if is_uutiennhom:
        ...
        danhsachuutien = [
            # (VITRIKYNANG_DAUCHUYENTINHDI, "sudungkynangkhongmuctieu", lambda: noilucconlai > 2400 and not diachidoituongcanbommau and not is_cohieuungdauchuyentinhdi, KHOANGCACHSUDUNGKYNANGTAMXA, None, False),
            ...
            (VITRIKYNANG_DONGIAPTRAN, "sudungkynangphudau", lambda: noilucconlai > 200 and (is_cohieuungdauchuyentinhdi or self._is_tudongvebanrac) and diachimuctieu and is_contranky and self._is_nhieumuctieugan3 and phantramnoiluc > 25 and khoangcachmuctieutancong <= KHOANGCACHSUDUNGKYNANGTAMXA, khoangcachmuctieutancong + random.randint(0, 1), None, True),
            (VITRIKYNANG_KYMONTRAN, "sudungkynangphudau", lambda: noilucconlai > 200 and (is_cohieuungdauchuyentinhdi or self._is_tudongvebanrac) and diachimuctieu and is_contranky and self._is_nhieumuctieugan3 and phantramnoiluc > 25 and khoangcachmuctieutancong <= KHOANGCACHSUDUNGKYNANGTAMXA, khoangcachmuctieutancong + random.randint(-1, 0), None, True),
            (VITRIKYNANG_LIETPHONGQUYET, "sudungkynangmuctieu", lambda: noilucconlai > 200 and (is_cohieuungdauchuyentinhdi or self._is_tudongvebanrac) and diachimuctieu and khoangcachmuctieutancong <= KHOANGCACHSUDUNGKYNANGTAMXA, KHOANGCACHSUDUNGKYNANGTAMXA, None, True),
        ...
        if self._is_tudongtrieuhoibaothudautien:
            while True:
                ...
                if self.moitruong.get_is_datrieuhoibaothudautien():
                    ...
                    if diachicosonhanvatbaothudautien and not any(tenbaothumaoson in tendoituong for tenbaothumaoson in BAOTHUKYNANGTRIEUHOIs):
                        if self.moitruong.get_idbandohientai() in BANDOKHONGPKs:
        ...
        if self._is_tudongsudungkynangbaothu:
            while True:
                ...
                if set(idkynangbaothu_map.keys()) & idkynangbaothucothesudungs:
                    ...
                    tendoituongmuctieu = diachimuctieu and self.moitruong.get_tendoituong(diachimuctieu)
                    is_muctieulacuongthi = tendoituongmuctieu and any(tenbaothu in tendoituongmuctieu for tenbaothu in BAOTHUKYNANGTRIEUHOIs)
                    if diachimuctieu and (self.moitruong.get_is_nguoichoi(diachimuctieu) or is_muctieulacuongthi) and self.moitruong.get_noilucconlaibaothudautien() >= 60:
    ...
    def action_xulygomquai(self):
        ...
        if diachimuctieudangchon:
            ...
            is_muctieudangchonlacuongthi = tendoituongmuctieudangchon and any(tenbaothu in tendoituongmuctieudangchon for tenbaothu in BAOTHUKYNANGTRIEUHOIs)
            if self.moitruong.get_is_nguoichoi(diachimuctieudangchon) or is_muctieudangchonlacuongthi: # or self.moitruong.get_is_baothugiangho(tendoituongmuctieudangchon):
                self._is_danggomquai = False
                self._yeucaugomquai = None
                self._idquaidangkeo = 0
                self._danhsachidquaidagom.clear()
