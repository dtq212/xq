...
DIEMDANHXUNGQUANH_MAP = {
    ...
    "{}_{}".format(BANDO_CHIENTRUONG, PHELIEMPHA): [(106, 80, 903), (60, 49, 903)],
    "{}_{}".format(BANDO_CHIENTRUONG, PHEBACHKHOI): [(147, 111, 903), (181, 141, 903)]
}
...
NHANVATTODOITUDONGs = (4599, 4676, 2303,                ) #195, 2331, 689, 1591, 1104)
...
NHANVATCUNGBANGs = (
    ...
    592, 1095, 538, 2478, 2834, 2555, 807, 4599, 2331, 3943, 64, 3941, 682, 4005, 654, 600, *NHANVATTODOITUDONGs)
