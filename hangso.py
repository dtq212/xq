...
BANDOFARMs = (549, 541, 264, 510, 511, 512, 513, BANDO_BACHMATRANG, BANDO_TUONGLANG, BANDO_QUELANG, BANDO_MUCDA, BANDO_RANHGIOIDAMLAY, BANDO_MADAPHO, BANDO_KENHTRINHQUOC1, BANDO_KENHTRINHQUOC2, BANDO_YENTRUONGTHANH1, BANDO_YENTRUONGTHANH2, BANDO_KENHTRINHQUOC3)
...
VATPHAMTUDONGNHATs = (HACCAU, LAMCAU, HOACAU, HONGCAU, TUSAMDON, CAPCUUDON)
VATPHAMKHONGBANs = (*VATPHAMTUDONGNHATs, *BAOTHUVATPHAMs, TIEUDAOTAN, QUYNGUYENDON, KIMTANGTAN, KHIMACHDON, XALOITU, NGANHANHTU, TUTINHDON, PHUCSINHDON, CAOCAPBAOTHUTHUCPHAM, ANXAPHU, TIEUHUYETTHACH, TIEUPHAPLUCTHACH, NHANSAM)
...
NHANVATCUNGBANGs = (
    ...
    435, 1129, 53, 65, 163, 807, 1950, 37, 126, 42, 1860, 100, 2069, 1766, 655, 122, 36, 1369, 888,
    592, 1095, 538, 2478, 2834, 2555, 807, 2331, 3943, 64, 3941, 682, 4005, 654, 600, 2338, 42, 1741, 42, 2962, 13, 121, 4599, 2303, 4676, *NHANVATTODOITUDONGs)