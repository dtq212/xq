...
class TacTu:
    ...
    def action_tudongtimkiemmuctieu(self):
        if self._is_tudongtimkiemmuctieu:
            ...
            idcanxoas = [k for k, v in self._idmuctieubiloi_map.items() if time.time() - v > 120]
            for k in idcanxoas:
    ...
    def _action_tancong_duongmon(self):
        ...
        danhsachuutien = [
            ...
            (None, "battathieuungphapbao", lambda: diachimuctieu and khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN and time.time() - self._thoidiembattathieuungphapbaogannhat > 2., None, False, True),
