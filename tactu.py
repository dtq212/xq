...
class TacTu:
            ...
            while True:
                ...
                if diachicosothongtinnhanvatmuctieudangchon:
                    ...
                    if is_bandokhongtancong:
                        ...
                        tendoituongmuctieudangchon = tendoituongmuctieudangchon
    ...
    def action_tudongsudungvatpham(self):
        if self._is_tudongsudungvatpham:
            ...
            # if time.time() - self._thoidiemsudungphihanhphugannhat >= .5 and self.moitruong.get_phantramsinhlucconlai() <= 25. and not self.moitruong.get_is_kynangsansang(*VITRIKYNANG_TIENTHANVODICH) and 0 < self.moitruong.get_thoigianconlaihieuungkimcuongbathoaidon(macdinh = 2.0) <= 1.5:
            #     self._thoidiemsudungphihanhphugannhat = time.time()
            ...
            while True:
                ...
                if diachicosothongtinnhanvatmuctieudangchon:
                    ...
                    if khoangcach <= KHOANGCACHSUDUNGKYNANGTAMXA - 3:
                        if is_muctieudangchonlanguoichoi and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_TRAMMAC, HIEUUNGKYNANG_CHOANG), False, diachicosothongtinnhanvat = diachicosothongtinnhanvatmuctieudangchon, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_PHONGANTHUAT):
                        ...
                        elif is_muctieudangchonlanguoichoi and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_MULOA, HIEUUNGKYNANG_CHOANG), False, diachicosothongtinnhanvat = diachicosothongtinnhanvatmuctieudangchon, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_HUYENQUANGTHIEMANH):
                            is_tamngungdichuyensudungkynang = True
                            if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                        ...
                        elif not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_CHAYMAU, ), diachicosothongtinnhanvat = diachicosothongtinnhanvatmuctieudangchon, macdinh = True, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_PHONGVUKINHTHIEN):
                            is_tamngungdichuyensudungkynang = True
                            if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                ...
                if diachicosothongtinnhanvatphantramsinhlucthapnhat and phantramsinhlucconlaithapnhat <= 90. and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_KHIETVANQUYET):
                    is_tamngungdichuyensudungkynang = True
                    if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                ...
                if diachicosothongtinnhanvatphantramsinhlucthapnhat and phantramsinhlucconlaithapnhat <= 75. and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_SOTRI):
                    is_tamngungdichuyensudungkynang = True
                    if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                ...
                if diachicosothongtinnhanvatphantramsinhlucthapnhat and phantramsinhlucconlaithapnhat <= 90. and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_VODINHLUUTHUY):
                    is_tamngungdichuyensudungkynang = True
                    if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                ...
                if diachicosothongtinnhanvatchuacobuffnoicong and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_KIMCHAMDOACH):
                    is_tamngungdichuyensudungkynang = True
                    if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                        self.moitruong.action_sudungkynangvitrimuctieu(*VITRIKYNANG_KIMCHAMDOACH, diachicosothongtinnhanvatphantramsinhlucthapnhat, is_khongkiemtracothetancong = True)
                        break
                ...
                if khoangcach <= KHOANGCACHSUDUNGKYNANGTAMXA:
                    if is_muctieudangchonlanguoichoi and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_TRAMMAC,), False, diachicosothongtinnhanvat = diachicosothongtinnhanvatmuctieudangchon, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_PHONGANTHUAT):
                        is_tamngungdichuyensudungkynang = True
                        if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                            self.moitruong.action_sudungkynangvitrimuctieu(*VITRIKYNANG_PHONGANTHUAT)

                    elif is_muctieudangchonlanguoichoi and not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_MULOA,), False, diachicosothongtinnhanvat = diachicosothongtinnhanvatmuctieudangchon, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_HUYENQUANGTHIEMANH):
                        is_tamngungdichuyensudungkynang = True
                        if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                            self.moitruong.action_sudungkynangvitrimuctieu(*VITRIKYNANG_HUYENQUANGTHIEMANH)
                    ...
                    elif not self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_CHAYMAU, ), macdinh = True, diachicosothongtinnhanvat = diachicosothongtinnhanvatmuctieudangchon, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_PHONGVUKINHTHIEN):
                        is_tamngungdichuyensudungkynang = True
                        if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
                            self.moitruong.action_sudungkynangvitrimuctieu(*VITRIKYNANG_PHONGVUKINHTHIEN)
                ...
                if khoangcach <= KHOANGCACHTOIDAHOPLE:
                    ...
                    if thoigiantuthenhanvatdungim > 1.:
                        self.moitruong.action_dichuyengiukhoangcachtoida(diachicosothongtinnhanvatmuctieudangchon, 4.)
    ...
    def action_tudongsudungkynang_thucsondao(self):
        ...
        if self._is_tudongsudungkynang:
            while True:
                ...
                if phantramsinhlucconlai <= 25 or (is_muctieudangchonlanguoichoi and phantramsinhlucconlai <= 50) or (self.moitruong.get_capdonhanvat() <= 100 and self.moitruong.get_idnguoichoi() in NHANVATNGUYHIEMs):
                ...
                elif idtuthenhanvat == TUTHENHANVAT_DICHUYEN and khoangcach <= KHOANGCACHHIEUQUAKYNANGKHAITHIENTICHDIA and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_KHAITHIENTICHDIA) and not self.moitruong.get_is_vohieuhoadichuyen():
                ...
                if not is_muctieudangchonlanguoichoi and self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_KHONGTHUNHAPBACHNHAN, HIEUUNGKYNANG_MULOA), macdinh = False, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_TINHTAMQUYET):
                    self.moitruong.action_sudungkynangvitri(*VITRIKYNANG_TINHTAMQUYET)
                ...
                elif khoangcach <= KHOANGCACHSUDUNGKYNANGCANCHIEN and is_muctieudangchonlanguoichoi and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_DONDAOTRUCNHAP):
                    self.moitruong.action_sudungkynangvitrimuctieu(*VITRIKYNANG_DONDAOTRUCNHAP)
        ...
        if self._is_tudongsudungkynang:
            while True:
                ...
                if is_duoitheonguoichoi:
                    ...
                    is_tranhxanguoichoi = is_muctieudangchonlanguoichoi and khoangcach <= 3 and not self.moitruong.get_is_vohieuhoadichuyen()
                    ...
                    elif not is_muctieudangchonlanguoichoi and self.moitruong.get_is_cohieuungs((HIEUUNGKYNANG_TRAMMAC, HIEUUNGKYNANG_KHONGTHUNHAPBACHNHAN, HIEUUNGKYNANG_MULOA), macdinh = False, is_hieuungcoloi = 0) and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_TINHTAMQUYET):
                        self.moitruong.action_sudungkynangvitri(*VITRIKYNANG_TINHTAMQUYET)
                    ...
                    elif is_tranhxanguoichoi and idtuthenhanvat not in (TUTHENHANVAT_DICHUYEN, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO):
                        self.moitruong.action_dichuyengiukhoangcachtoithieu(diachicosothongtinnhanvatmuctieudangchon, khoangcachtoithieu = khoangcach + 1.5, delay = 3.)
                    ...
                    elif not is_muctieudangchonlanguoichoi and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_TIENNHANCHILO):
                        is_tamngungdichuyensudungkynang = True
                        if idtuthenhanvat in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_TANCONG, TUTHENHANVAT_SUDUNGKYNANGPHUTRO, TUTHENHANVAT_DELAYSAUTANCONG):
    ...
    def battat_tudonglamnhiemvulaoquangia(self):
        self._is_tudonglamnhiemvulaoquangia = not self._is_tudonglamnhiemvulaoquangia
        if self._is_tudonglamnhiemvulaoquangia:
            phatam("Bật tự động làm nhiệm vụ lão quản gia")
        else:
            phatam("Tắt tự động làm nhiệm vụ lão quản gia")
            ...
            while True:
                ...
                if tenvatpham in VATPHAMTUDONGNHATs:
                    ...
                    if khoangcach <= KHOANGCACHTOANMANHINH * 2:
                        if not self._diachicosovatphamdangnhat or not self.moitruong.get_is_vatphamtontai(self._diachicosovatphamdangnhat) or khoangcach < self.moitruong.get_khoangcach(self._diachicosovatphamdangnhat) or (tenvatpham == LIXI and self.moitruong.get_tendoituong(self._diachicosovatphamdangnhat) != LIXI):
                ...
                while True:
                    ...
                    if not self._is_tamngungdichuyensudungkynang and not self.moitruong.get_is_vohieuhoadichuyen():
                        if self.moitruong.get_tenmonphai() == "thucson" and self.moitruong.get_is_kynangsansang(*VITRIKYNANG_KHAITHIENTICHDIA, delay = 1.) and khoangcach >= 3 and self.moitruong.get_idbandohientai() != BANDO_BATQUAITRAN and self.moitruong.get_idtuthenhanvat() == TUTHENHANVAT_DUNGIM:
                            ...
                            self.moitruong.action_dichuyentiepcandiem(self.moitruong.get_toadox(self._diachicosovatphamdangnhat, is_vitrihientai = True), self.moitruong.get_toadoy(self._diachicosovatphamdangnhat, is_vitrihientai = True), delay = 1.)
                ...
                if self.moitruong.get_idbandohientai() == BANDO_BATQUAITRAN:
                    ...
                    while True:
                        ...
                        if self._tenmuctieubatquaitrantruocdo != "S19" or self._tenmuctieubatquaitranhientai != AOANHMADAO:
                            khoangcach = self.moitruong.get_khoangcach(diachicosothongtinvatphamxemxet)
                            if khoangcach <= 6.:
                                if time.time() - self._thoidiemmochangiabaoruonggannhat >= 1.5 and self.moitruong.get_idtuthenhanvat() in (TUTHENHANVAT_DUNGIM, TUTHENHANVAT_DELAYSAUTANCONG):
                                ...
                                self.moitruong.action_dichuyengiukhoangcachtoida(diachicosothongtinvatphamxemxet, khoangcachtoida = 3., delay = 1.)
        ...
        if self._is_tudongdibatquaitran:
            if self.moitruong.get_idbandohientai() == BANDO_TANTHUTHON:
                ...
                if not diachicosothongtinnhanvatbatquaitran or self.moitruong.get_khoangcach(diachicosothongtinnhanvatbatquaitran) > 4.:
                    self.moitruong.action_dichuyentiepcandiem(X_BATQUAITRAN, Y_BATQUAITRAN)
                else:
    ...
    def action_tudonglamnhiemvulaoquangia(self):
        if self._is_tudonglamnhiemvulaoquangia:
            if self.moitruong.get_idbandohientai() == BANDO_CHU:
                diachicosothongtinnhanvatbatquaitran = self.moitruong.action_timkiemnhanvat(tennhanvat = LAOQUANGIA)

                if diachicosothongtinnhanvatbatquaitran and self.moitruong.get_khoangcach(diachicosothongtinnhanvatbatquaitran) <= 6.:
                    iddoituong = self.moitruong.get_iddoituong(diachicosothongtinnhanvatbatquaitran)
                    if iddoituong:
                        is_ok = self.moitruong.action_trochuyenvoinpc(iddoituong, "welcome.1")
                        if is_ok:
    ...
    def action_tudongtimduong(self, x = False, y = False, idbando = False):
        ...
        if idbandohientai == BANDO_CHU:
            ...
            return
        elif idbandohientai == BANDO_VANMONGCOC:
            diachicosothongtinnhanvatxaphu = self.moitruong.action_timkiemnhanvat(tennhanvat = XAPHU)

            if not diachicosothongtinnhanvatxaphu or self.moitruong.get_khoangcach(diachicosothongtinnhanvatxaphu) > 6.:
                self.moitruong.action_dichuyentiepcandiem(X_XAPHU_VANMONGCOC, Y_XAPHU_VANMONGCOC)
            else:
                iddoituong = self.moitruong.get_iddoituong(diachicosothongtinnhanvatxaphu)
                if iddoituong:
                    self.moitruong.action_trochuyenvoinpc(iddoituong, "go")
    ...
    def action_tudongkhamdenkhithatbai(self):
        ...
        while True:
            if not self.moitruong.get_iddoituongvatphamhanhtrang(0):
                break
            if not self.moitruong.get_iddoituongvatphamhanhtrang(1):
                break
        ...
        for i in range(3):
            iddoituongvatphamhanhtrang8 = self.moitruong.get_iddoituongvatphamhanhtrang(7 + i * 6)
            if not iddoituongvatphamhanhtrang8:
                continue

            iddoituongvatphamhanhtrang7 = self.moitruong.get_iddoituongvatphamhanhtrang(6 + i * 6)
            if not iddoituongvatphamhanhtrang7:
                continue

            self.moitruong.action_dichuyenvatphamhanhtrang(iddoituongvatphamhanhtrang8, 7 + i * 6, delay = 0.)
            time.sleep(0.05)
            caulenh = "mix111255 12# {}# {}#".format(hex(iddoituongvatphamhanhtrang7), hex(iddoituongvatphamhanhtrang8)).replace("0x", "")
    ...
    def action_tudongepdo11(self, delay = 0.25):
        if time.time() - self._thoidiemepdogannhat < delay:
            return
        ...
        while sdfjhsdfsdf <= 10:
            ...
            caulenh = "mix1112555 12# {}# {}#".format(hex(iddoituongvatphamhanhtrang1), hex(iddoituongvatpham)).replace("0x", "")
                ...
                if socaps:
                    for i in range(2, 9):
                        for j in range(1, 49):
                            ...
                            if self.moitruong.get_is_vitriruongtrong(sothutuvitri):
                                is_dahet = True
