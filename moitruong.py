...
class MoiTruong:
    def __init__(self, idcuaso):
        ...
        self._is_dasetupautoassemblesudungtancongvatly = False
        ...
        self._is_dasetupautoassembledichuyenvatphamsanghanhtrangkhac = False
        self._is_dasetupautoassembletrieuhoibaothu = False
        self._is_dasetupautoassemblesudungthaotacbaothu = False
        self._is_dasetupautoassemblethietlapchedobaothu = False
        ...
        self._is_dasetupautoassembleralenhbaothutancong = False
        self._is_dasetupautoassembleralenhbaothutheosau = False
        self._is_dasetupautoassembletrieuhoibaothu = False
        self._is_dasetupautoassemblesudungvatphambaothu = False
        self._is_dasetupautoassemblenhatdotoado = False
        self._is_dasetupautoassemblekhoitaothongtinbando = False
    ...
    def __del__(self):
        ...
        if getattr(self, "_is_dasetupactionthietlaphooknoidungtrochuyen", False):
            safe_free("_is_dasetupactionthietlaphooknoidungtrochuyen", "_addr_buffer_noidungchat")
            safe_free("_is_dasetupactionthietlaphooknoidungtrochuyen", "_addr_hook_chat_script")

        mem_map = [
            ("_is_dasetupautoassemblesudungtancongvatly", "_diachiautoassemblesudungtancongvatly"),
            ...
            ("_is_dasetupautoassemblethucthicaulenh", "_diachiautoassemblethucthicaulenh"),
            ("_is_dasetupautoassemblesudungthaotacbaothu", "_diachiautoassemblesudungthaotacbaothu"),
            ("_is_dasetupautoassemblethietlapchedobaothu", "_diachiautoassemblethietlapchedobaothu"),
            ("_is_dasetupautoassemblesudungkynangbaothu", "_diachiautoassemblesudungkynangbaothu"),
            ("_is_dasetupautoassembleralenhbaothutancong", "_diachiautoassembleralenhbaothutancong"),
            ("_is_dasetupautoassembleralenhbaothutheosau", "_diachiautoassembleralenhbaothutheosau"),
            ("_is_dasetupautoassembletrochuyenvoinpc", "_diachiautoassembletrochuyenvoinpc"),
            ("_is_dasetupautoassemblesudungvatpham", "_diachiautoassemblesudungvatpham"),
            ("_is_dasetupautoassembledichuyenvatphamhanhtrang", "_diachiautoassembledichuyenvatphamhanhtrang"),
            ("_is_dasetupautoassembledichuyenvatphamsanghanhtrangkhac", "_diachiautoassembledichuyenvatphamsanghanhtrangkhac"),
            ("_is_dasetupautoassemblethaotacnhom", "_diachiautoassemblethaotacnhom"),
            ("_is_dasetupautoassemblesudungkynang", "_diachiautoassemblesudungkynang"),
            ("_is_dasetupautoassemblesudungkynangmuctieunguoichoi", "_diachiautoassemblesudungkynangmuctieunguoichoi"),
            ("_is_dasetupautoassemblesudungkynangmuctieukhacnguoichoi", "_diachiautoassemblesudungkynangmuctieukhacnguoichoi"),
            ("_is_dasetupautoassemblesudungkynangtoado", "_diachiautoassemblesudungkynangtoado"),
            ("_is_dasetupautoassemblenhatdo", "_diachiautoassemblenhatdo"),
            ("_is_dasetupautoassemblenhatdotoado", "_diachiautoassemblenhatdotoado"),
            ("_is_dasetupautoassemblekhaikhoang", "_diachiautoassemblekhaikhoang"),
            ("_is_dasetupautoassembletrieuhoibaothu", "_diachiautoassembletrieuhoibaothu"),
            ("_is_dasetupautoassemblesudungvatphambaothu", "_diachiautoassemblesudungvatphambaothu")
        ]
    ...
    def get_soluongvatphamhanhtrang(self, idvitri):
        ...
        if not x:
            return False
        return read_int(self.tientrinh, x + idvitri * 0x4 + 0x1D6CC)
    ...
    def get_danhsachidnguoichoixungquanhs(self):
        ...
        while i < MAX_LOOP:
            ...
            if not idnguoichoi:
                continue
            if self.get_khoangcach(diachicosothongtinnhanvatxemxet) > KHOANGCACHTOANMANHINH:
                continue
    ...
    def get_idnguoichoixungquanh_map(self):
        ...
        while i < MAX_LOOP:
            ...
            if not self.get_is_nhanvattontai(diachicosothongtinnhanvatxemxet):
                continue
            if not self.get_is_nguoichoi(diachicosothongtinnhanvatxemxet):
                continue
            if self.get_khoangcach(diachicosothongtinnhanvatxemxet) > KHOANGCACHTOANMANHINH:
                continue
    ...
    def get_is_cothegaychoang(self, diachicosothongtinnhanvat, thoigiangiancach = 2.0):
        ...
        if not self.get_is_nguoichoi(diachicosothongtinnhanvat):
            return False
        ...
        if self.get_is_cohieuungs((HIEUUNGKYNANG_CHOANG,), False, diachicosothongtinnhanvat, is_hieuungcoloi = 0):
            return False
    ...
    def get_is_kynangsansang(self, idvitri_x, idvitri_y, delay = 0.):
        ...
        return idkynang and is_dahockynang and is_khongcothoigiangiancach  # and time.time() - self._thoidiemsudungkynangvitrigannhat_map.get((idvitri_x, idvitri_y), 0.) > delay
    ...
    def get_is_baothugiangho(self, tendoituong):
        return "(" in tendoituong and "(cấp" not in tendoituong
                ...
                try:
                    ...
                    if tenchunhan:
                        if tenchunhan == self.get_tendoituong():
                            return False
                        elif tenchunhan in TENNGUOICHOICUNGBANGs:
                            return False
    ...
    def action_thucthicaulenh(self, caulenh, delay = 0.2):
    ...
    def action_ralenhbaothutancong(self, iddoituongbaothu, iddoituongnhanvatmuctieudangchon, delay = 0.4):
        ...
        self.auto_assemble_ralenhbaothutancong(iddoituongbaothu, iddoituongnhanvatmuctieudangchon)
    ...
    def action_ralenhbaothutheosau(self, iddoituongbaothu, delay = 0.4):
        ...
        self.auto_assemble_ralenhbaothutheosau(iddoituongbaothu)
    ...
    def action_dichuyenvatphamsanghanhtrangkhac(self, iddoituong, vitri, delay = 0.4):
        ...
        self.auto_assemble_dichuyenvatphamsanghanhtrangkhac(iddoituong, vitri)

        return True

    def action_trochuyenvoinpc(self, iddoituong, noidungtrochuyen, delay = 0.2):
    ...
    def auto_assemble_ralenhbaothutancong(self, iddoituongbaothu, iddoituongnhanvatmuctieudangchon):
        caulenh = f"pet {hex(iddoituongbaothu)}# 1 {hex(iddoituongnhanvatmuctieudangchon)}#".replace("0x", "")
        # print(f"{self.get_tendoituong()} auto_assemble_ralenhbaothutancong: {caulenh}")

        if not self._is_dasetupautoassembleralenhbaothutancong:
            self._diachiautoassembleralenhbaothutancong = self.tientrinh.allocate(128)

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutancong, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 1, len(caulenh.encode("utf-8")))

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 5, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 6, self._diachiautoassembleralenhbaothutancong + 19)

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 10, bytes.fromhex("E8"), 1)
            write_int(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 11, self.diachixq + 0x95450 - (self._diachiautoassembleralenhbaothutancong + 10) - 5)

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 15, bytes.fromhex("83 C4 08"), 3)
            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 18, bytes.fromhex("C3"), 1)

            write_string(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 19, caulenh)

            self._is_dasetupautoassembleralenhbaothutancong = True
        else:
            if read_int(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 1) != len(caulenh.encode("utf-8")):
                write_int(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 1, len(caulenh.encode("utf-8")))
            if read_string(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 19) != caulenh:
                write_string(self.tientrinh, self._diachiautoassembleralenhbaothutancong + 19, caulenh)

        self.tientrinh.start_thread(self._diachiautoassembleralenhbaothutancong)
        time.sleep(0.05)

    def auto_assemble_ralenhbaothutheosau(self, iddoituongbaothu):
        caulenh = f"pet {hex(iddoituongbaothu)}# 2".replace("0x", "")
        # print(f"{self.get_tendoituong()} auto_assemble_ralenhbaothutheosau: {caulenh}")

        if not self._is_dasetupautoassembleralenhbaothutheosau:
            self._diachiautoassembleralenhbaothutheosau = self.tientrinh.allocate(128)

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutheosau, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 1, len(caulenh.encode("utf-8")))

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 5, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 6, self._diachiautoassembleralenhbaothutheosau + 19)

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 10, bytes.fromhex("E8"), 1)
            write_int(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 11, self.diachixq + 0x95450 - (self._diachiautoassembleralenhbaothutheosau + 10) - 5)

            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 15, bytes.fromhex("83 C4 08"), 3)
            write_bytes(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 18, bytes.fromhex("C3"), 1)

            write_string(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 19, caulenh)

            self._is_dasetupautoassembleralenhbaothutheosau = True
        else:
            if read_int(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 1) != len(caulenh.encode("utf-8")):
                write_int(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 1, len(caulenh.encode("utf-8")))
            if read_string(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 19) != caulenh:
                write_string(self.tientrinh, self._diachiautoassembleralenhbaothutheosau + 19, caulenh)

        self.tientrinh.start_thread(self._diachiautoassembleralenhbaothutheosau)
        time.sleep(0.05)
    ...
    def auto_assemble_sudungtancongvatly(self, iddoituong, caulenh = False):
        ...
        if not self._is_dasetupautoassemblesudungtancongvatly:
            ...
            write_bytes(self.tientrinh, self._diachiautoassemblesudungtancongvatly + 10, bytes.fromhex("E8"), 1)
            write_int(self.tientrinh, self._diachiautoassemblesudungtancongvatly + 11, self.diachixq + 0x95450 - (self._diachiautoassemblesudungtancongvatly + 10) - 5)

            write_bytes(self.tientrinh, self._diachiautoassemblesudungtancongvatly + 15, bytes.fromhex("83 C4 08"), 3)
            write_bytes(self.tientrinh, self._diachiautoassemblesudungtancongvatly + 18, bytes.fromhex("C3"), 1)
        ...
        self.tientrinh.start_thread(self._diachiautoassemblesudungtancongvatly)
        time.sleep(0.05)
    ...
    def auto_assemble_dichuyenvatphamsanghanhtrangkhac(self, iddoituong, vitri):
        caulenh = "move {}# to {}".format(hex(iddoituong), vitri).replace("0x", "")
        #print("{} auto_assemble_dichuyenvatphamsanghanhtrangkhac: {} {} {}".format(self.get_tendoituong(), iddoituong, vitri, caulenh))
        if not self._is_dasetupautoassembledichuyenvatphamsanghanhtrangkhac:
            self._diachiautoassembledichuyenvatphamsanghanhtrangkhac = self.tientrinh.allocate(128)

            write_bytes(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 1, len(caulenh.encode("utf-8")))

            write_bytes(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 5, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 6, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 19)

            write_bytes(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 10, bytes.fromhex("E8"), 1)
            write_int(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 11, self.diachixq + 0x95450 - (self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 10) - 5)

            write_bytes(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 15, bytes.fromhex("83 C4 08"), 3)
            write_bytes(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 18, bytes.fromhex("C3"), 1)

            write_string(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 19, caulenh)

            self._is_dasetupautoassembledichuyenvatphamsanghanhtrangkhac = True
        else:
            if read_int(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 1) != len(caulenh.encode("utf-8")):
                write_int(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 1, len(caulenh.encode("utf-8")))
            if read_string(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 19) != caulenh:
                write_string(self.tientrinh, self._diachiautoassembledichuyenvatphamsanghanhtrangkhac + 19, caulenh)

        self.tientrinh.start_thread(self._diachiautoassembledichuyenvatphamsanghanhtrangkhac)
        time.sleep(0.05)
    ...
    def auto_assemble_dichuyen(self, x, y):  # Thêm tham số is_batbuoc
    ...
    def action_nhatdo(self, diachicosothongtinvatpham, delay = 0.05):
        ...
        if time.time() - self._thoidiemnhatdogannhat_map.get(diachicosothongtinvatpham, time.time() - 2.) < 0.4:
            return
    ...
    def get_toadoxbaothudautien(self):
        x = read_int(self.tientrinh, self.diachixq + 0x372864)
        if not x:
            return False
        return read_int(self.tientrinh, x + 0x1B4)

    def get_toadoybaothudautien(self):
        x = read_int(self.tientrinh, self.diachixq + 0x372864)
        if not x:
            return False
        return read_int(self.tientrinh, x + 0x1B8)

    def get_idbandobaothudautien(self):
        x = read_int(self.tientrinh, self.diachixq + 0x372864)
        if not x:
            return False
        return read_int(self.tientrinh, x + 0x1E4)

    def get_tenbaothudautien(self):
        x = read_int(self.tientrinh, self.diachixq + 0x372864)
        if not x:
            return False
    ...
    def auto_assemble_sudungthaotacbaothu(self, iddoituong, idkynang):
        ...
        if not self._is_dasetupautoassemblesudungthaotacbaothu:
            self._diachiautoassemblesudungthaotacbaothu = self.tientrinh.allocate(128)

            write_bytes(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 1, len(caulenh.encode("utf-8")))

            write_bytes(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 5, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 6, self._diachiautoassemblesudungthaotacbaothu + 19)

            write_bytes(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 10, bytes.fromhex("E8"), 1)
            write_int(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 11, self.diachixq + 0x95450 - (self._diachiautoassemblesudungthaotacbaothu + 10) - 5)

            write_bytes(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 15, bytes.fromhex("83 C4 08"), 3)
            write_bytes(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 18, bytes.fromhex("C3"), 1)

            write_string(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 19, caulenh)

            self._is_dasetupautoassemblesudungthaotacbaothu = True
        else:
            if read_int(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 1) != len(caulenh.encode("utf-8")):
                write_int(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 1, len(caulenh.encode("utf-8")))
            if read_string(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 19) != caulenh:
                write_string(self.tientrinh, self._diachiautoassemblesudungthaotacbaothu + 19, caulenh)
    ...
    def action_thietlapchedobaothu(self, iddoituong, idkynang, delay = 0.2):
        ...
        self.auto_assemble_thietlapchedobaothu(iddoituong, idkynang)

        return True

    def auto_assemble_thietlapchedobaothu(self, iddoituong, idkynang):
        caulenh = "pet {}# mode {}".format(hex(iddoituong), idkynang).replace("0x", "")
        if not self._is_dasetupautoassemblethietlapchedobaothu:
            self._diachiautoassemblethietlapchedobaothu = self.tientrinh.allocate(128)

            write_bytes(self.tientrinh, self._diachiautoassemblethietlapchedobaothu, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 1, len(caulenh.encode("utf-8")))

            write_bytes(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 5, bytes.fromhex("68"), 1)
            write_int(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 6, self._diachiautoassemblethietlapchedobaothu + 19)

            write_bytes(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 10, bytes.fromhex("E8"), 1)
            write_int(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 11, self.diachixq + 0x95450 - (self._diachiautoassemblethietlapchedobaothu + 10) - 5)

            write_bytes(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 15, bytes.fromhex("83 C4 08"), 3)
            write_bytes(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 18, bytes.fromhex("C3"), 1)

            write_string(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 19, caulenh)

            self._is_dasetupautoassemblethietlapchedobaothu = True
        else:
            if read_int(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 1) != len(caulenh.encode("utf-8")):
                write_int(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 1, len(caulenh.encode("utf-8")))
            if read_string(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 19) != caulenh:
                write_string(self.tientrinh, self._diachiautoassemblethietlapchedobaothu + 19, caulenh)
    ...
    def action_sudungkynangbaothu(self, idkynang, diachimuctieu, delay = 0.5):
        ...
        self.auto_assemble_sudungkynangbaothu(caulenh)

        return True

    def auto_assemble_sudungkynangbaothu(self, caulenh):
