...
class MoiTruong:
    def __init__(self, idcuaso):
        ...
        self._thoidiemsudungkynangphapbaogannhat = time.time() - 2.5
    ...
    def __del__(self):
        ...
        if self._is_dasetupautoassemblesudungkynangphapbao:
            self.tientrinh.free(self._diachiautoassemblesudungkynangphapbao)
