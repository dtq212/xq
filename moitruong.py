...
class MoiTruong:
    ...
    def __del__(self):
        ...
        safe_free("_is_dasetupautoassemblenhatruong", "_diachiautoassemblenhatruong")
    ...
    def action_ralenhbaothumaosontancong(self, iddoituongbaothumaoson, iddoituongnhanvatmuctieudangchon, delay = 0.25):
