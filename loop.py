...
class LoopChinh:
    ...
    def step(self):
        ...
        #    self.moitruong.action_thucthicaulenh("tallk 294# bonus.1")
        #    time.sleep(0.25)
        #    self.moitruong.action_thucthicaulenh("tallk 294# bonus.28")
        #    time.sleep(0.25)
        #    self.moitruong.action_thucthicaulenh("tallk 294# bonus.29")
        #    time.sleep(0.25)
